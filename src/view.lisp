...
(defun render (template-path &optional env &key (render-lsx t))
...
(defun render-with-root (template-path &key (root-env nil) (env nil))
  (render *template-root* (concatenate 'list `(:content ,(render template-path env :render-lsx nil)) root-env)))
